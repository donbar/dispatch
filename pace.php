...
?>
	...
	function changelogin(){
		...
		document.truck.initial.value=1;
...
<?php
print "<body>";
print "<form name='truck' method='post' action='pacemanager.php'>";
print "<input type='hidden' name='event_id'>";
print "<input type='hidden' name='initial'>";
...
print "<span class='welcome'><center>Welcome to Safety Dispatch v".$version." - Pace Login</center></span><br>";
